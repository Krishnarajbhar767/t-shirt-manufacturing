      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Ready to start your custom manufacturing project? Get in touch with our team for a free consultation and quote.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form
                action="https://formsubmit.co/info@tshirtfactory.co.in"
                method="POST"
                className="space-y-6"
              >
                <input type="hidden" name="_captcha" value="false" />
                <input type="hidden" name="_next" value="https://tshirtfactory.co.in/" />
                ...
                <div>
                  ...
                  <select id="service" name="service" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600">
                    ...
                    <option value="aprons">Custom Aprons</option>
                    <option value="bags">Jute & Cotton Bags</option>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@tshirtfactory.co.in</p>
                  </div>
                </div>
            ...
            {[
              {
                ...
                answer: "Our minimum order quantity varies by product, typically starting at 25 pieces for most items.",
              },
              {
                question: "How long does production take?",
                answer: "Standard production time is 7–14 business days after design approval. Rush orders available.",
              },
              {
                question: "Do you provide design services?",
                answer: "Yes! Our expert design team can help create custom artwork or adapt your existing designs.",
              },
              {
                question: "What file formats do you accept?",
                answer: "We accept AI, EPS, PDF, PNG, and high-res JPG. Vector formats are preferred.",
              },
              {
                question: "Do you ship internationally?",
                answer: "Yes, we ship worldwide. Shipping cost and delivery times depend on destination.",
              },
              {
                question: "What is your return policy?",
                answer: "We remake defective items at no charge. Custom orders are non-returnable unless defective.",
              },
            ].map((faq, index) => (
